var LandMat = {
  ...
  uniforms: THREE.UniformsUtils.merge( [
		...
		THREE.UniformsLib[ 'fog' ],
    {
      ...
      customShadowMap: { type: "t", value: null },
  ...
  `
    ...
    noiseColor = vec3(
      ...
      // #if defined( USE_ENVMAP ) || defined( PHONG ) || defined( PHYSICAL ) || defined( LAMBERT ) || defined( DISTANCE ) || defined ( USE_SHADOWMAP )
      		...
      		vec4 worldPosition = modelMatrix * vec4( nPos, 1.0 );
  ...
  `
    ...
    // gl_FragColor = diffuseColor * texture2D(customShadowMap, staticUV);
    gl_FragColor.rgb = vec3( texture2D(customShadowMap, staticUV).a ) * 100.0;
    gl_FragColor.a = 1.0;
