...
STATUS.FORCEEFFECTS=-1<window.location.href("?forceefffects");function getMobileOperatingSystem(){var a=navigator.userAgent||navigator.vendor||window.opera;return/windows phone/i.test(a)?"Windows Phone":/android/i.test(a)?"Android":/iPad|iPhone|iPod/.test(a)&&!window.MSStream?"iOS":"unknown"}STATUS.MOBILEOS=getMobileOperatingSystem();STATUS.ISMOBILE=!1;-1==STATUS.MOBILEOS.indexOf("unknown")&&(STATUS.ISMOBILE=!0);var SOCKETSERVER="https://exalandsocket.spime.im",noSleep=new NoSleep;HLMain={};
var frameCount=0,millis=0,delta=0;
