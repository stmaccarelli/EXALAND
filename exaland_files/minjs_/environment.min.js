...
motorola:"assets/3dm/motorola.jpg",chainsaw:"assets/3dm/chainsaw.png",crocodile:"assets/3dm/crocodile.jpg",dolphin:"assets/3dm/dolphin.png",elephant:"assets/3dm/elephant.jpg",garbage:"assets/3dm/garbage.jpg",moab:"assets/3dm/moab.png",orca:"assets/3dm/orca.png",stingray:"assets/3dm/stingray.png",turtle:"assets/3dm/turtle.jpg",walrus:"assets/3dm/walrus.jpg",trex:"assets/3dm/trex.png"},dynamicTextures:{stars:null,textbox:null},models:{ducky:["assets/3dm/ducky.obj",10],airbus:["assets/3dm/airbus.obj",
8],aurora:["assets/3dm/aurora.obj",5],helicopter:["assets/3dm/helicopter.obj",4],heartbomb:["assets/3dm/heartbomb.obj",4],cube:["assets/3dm/cube.obj",5],motorola:["assets/3dm/motorola.obj",12],barrel:["assets/3dm/barrel.obj",5],chainsaw:["assets/3dm/chainsaw.obj",2],garbage:["assets/3dm/garbage.obj",5],moab:["assets/3dm/moab.obj",5],whale:["assets/3dm/whale.obj",5],elephant:["assets/3dm/elephant.obj",10],crocodile:["assets/3dm/crocodile.obj",10],dolphin:["assets/3dm/dolphin.obj",10],orca:["assets/3dm/orca.obj",
10],stingray:["assets/3dm/stingray.obj",15],turtle:["assets/3dm/turtle.obj",25],walrus:["assets/3dm/walrus.obj",20],trex:["assets/3dm/trex.obj",5]},modelsKeys:null,mGroups:{space:"aurora airbus helicopter moab chainsaw garbage".split(" "),sea:"whale crocodile dolphin orca stingray turtle walrus".split(" "),bigfishes:["whale","dolphin","orca","walrus"],ducks:["ducky"],buildings:["building6"],waste:["barrel","garbage","moab"],civilization:"barrel garbage airbus helicopter aurora ducky moab chainsaw".split(" "),
everything:"trex whale ducky airbus aurora helicopter heartbomb cube barrel chainsaw garbage moab elephant crocodile dolphin orca stingray turtle walrus".split(" ")},dynamicModelsClones:{length:0},sky:null,land:null,sea:null,clouds:!0,flora:null,fauna:null,lights:{ambient:null,directional:null,sun:null}},HLEnvironment=function(){function a(){var a=new THREE.TextureLoader(HL.texturesLoadingManager),d;for(d in HL.textures)null!=HL.textures[d]?(h++,HL.textures[d]=a.load(HL.textures[d],function(a){return function(){g++;
...
HL.geometries.clouds.name="clouds-geometry";HLH.initBufParticleSystem(HL.geometries.clouds,2*HLE.WORLD_WIDTH,HLE.WORLD_HEIGHT,HLE.CLOUDS_AMOUNT,!0,!0)}function m(){HL.materials.sky=new THREE.SkyShaderMaterial({wireframe:STATUS.WIREFRAME,wireframeLinewidth:2,map1:STATUS.WIREFRAME?null:!0,map2:STATUS.WIREFRAME?null:!0,map3:STATUS.WIREFRAME?null:!0});HL.materials.sky.uniforms.color.value=HLC.horizon;HL.materials.land=new THREE.LandShaderMaterial(HLE.WORLD_WIDTH,HLE.WORLD_TILES,{color:HLC.land,wireframe:STATUS.WIREFRAME,
map:STATUS.WIREFRAME?null:new THREE.Texture,fog:!0,repeatUV:new THREE.Vector2(2,2),centerPath:HLE.CENTER_PATH,side:THREE.DoubleSide,flatShading:!0,transparent:!1,hardMix:!0});HL.materials.land.uniforms.worldColor.value=HLC.horizon;HL.materials.land.uniforms.skyColor.value=HLC.horizon;HL.materials.land.uniforms.withCenterPath.value=HLE.CENTER_PATH;HL.materials.land.uniforms.advance.value=HLE.acceleration;HL.materials.land.uniforms.noiseFreq.value=HLE.noiseFrequency;HL.materials.land.uniforms.noiseFreq2.value=
HLE.noiseFrequency2;HL.materials.land.uniforms.landHeight.value=1.3*HLE.landHeight;HL.materials.land.uniforms.landZeroPoint.value=HLE.landZeroPoint;HLE.WATER||HLE.MIRROR||(HL.materials.sea=new THREE.MeshBasicMaterial({color:HLC.sea,fog:!0,wireframe:STATUS.WIREFRAME,wireframeLinewidth:2,transparent:!1,opacity:.9,alphaTest:.5}),HL.materials.sea.color=HLC.sea);HLE.MIRROR&&(HL.materials.mirror=new THREE.Mirror(HL.renderer,HL.camera,{clipBias:0,textureWidth:512,textureHeight:512,color:0,fog:!0,side:THREE.DoubleSide,
worldWidth:HLE.WORLD_WIDTH,transparent:!1,opacity:1,wireframe:STATUS.WIREFRAME,wireframeLinewidth:2}),HL.materials.mirror.rotateX(-Math.PI/2));HLE.WATER&&(HL.materials.water=new THREE.Water(HL.renderer,HL.camera,HL.scene,{textureWidth:STATUS.CARDBOARD?200:512,textureHeight:STATUS.CARDBOARD?200:512,noiseScale:.5,distortionScale:100,sunDirection:HL.lights.sun.position.normalize(),color:HLC.sea,opacity:.9,fog:!0,side:THREE.DoubleSide,blur:!0,wireframe:STATUS.WIREFRAME,wireframeLinewidth:2}),HL.materials.water.sunColor=
HLC.horizon);HL.materials.clouds=new THREE.PointsMaterial({color:HLC.clouds,side:THREE.DoubleSide,opacity:1,transparent:!1,size:STATUS.CARDBOARD||STATUS.VR?6:12,fog:!0,sizeAttenuation:!0,depthWrite:!0});HL.materials.clouds.color=HLC.clouds;for(var a in HL.models)HL.materials[a]=new THREE.MeshLambertMaterial({color:0,map:STATUS.WIREFRAME?null:new THREE.Texture,fog:!0,wireframe:STATUS.WIREFRAME,wireframeLinewidth:2,side:THREE.DoubleSide,transparent:!0,flatShading:!1}),HL.materials[a].color=new THREE.Color(16777215)}
function n(){var a=new THREE.OBJLoader(HL.modelsLoadingManager,!1),d,b,c;for(c in HL.models)null!==HL.models[c]&&(d=HL.models[c][0],b=HL.models[c][1],a.load(d,function(a,d){return function(b){HL.models[a]=new THREE.Mesh(b.children[0].geometry);HL.models[a].name=a;HL.models[a].geometry.scale(d,d,d);HL.models[a].geometry.computeBoundingBox();HL.models[a].size=new THREE.Vector3;HL.models[a].geometry.boundingBox.getSize(HL.models[a].size);HL.models[a].material=HL.materials[a];HL.scene.add(HL.models[a]);
HLH.resetModel(HL.models[a])}}(c,b)));HL.modelsKeys=Object.keys(HL.models)}var h=0,g=0,l=2,k=0;return{init:function(){var g=new Event("HLAssetLoaded");HL.texturesLoadingManager=new THREE.LoadingManager;HL.texturesLoadingManager.onStart=function(a,b,c){console.log("Started loading textures")};HL.texturesLoadingManager.onLoad=function(){console.log("Textures loading complete!");for(var a in HL.models)HL.materials[a].map=void 0!==HL.textures[a]?HL.textures[a]:null;HL.materials.sky.uniforms.map1.value=
HL.textures.sky1;HL.materials.sky.uniforms.map2.value=HL.textures.sky2;HL.materials.sky.uniforms.map3.value=HL.textures.sky3;HL.materials.water.material.uniforms.normalSampler.value=HL.textures.water;console.log("Textures assigned to materials\ndispatching HLAssetLoaded event");window.dispatchEvent(g)};HL.texturesLoadingManager.onProgress=function(a,b,c){HL.texturesLoaded=b;HL.totalTextures=c;console.log("Completed loading texture: "+a+".\nLoaded "+b+" of "+c+" files.")};HL.texturesLoadingManager.onError=
function(a){console.error("There was an error loading texture "+a);alert("Textures: a loading error occurred. Please reload.")};HL.modelsLoadingManager=new THREE.LoadingManager;HL.modelsLoadingManager.onStart=function(a,b,c){console.log("Started loading models")};HL.modelsLoadingManager.onLoad=function(){console.log("Models Loading complete!\ndispatching HLAssetLoaded event");window.dispatchEvent(g)};HL.modelsLoadingManager.onProgress=function(a,b,c){HL.modelsLoaded=b;HL.totalModels=c;console.log("Completed loading model: "+
a+".\nLoaded "+b+" of "+c+" files.")};HL.modelsLoadingManager.onError=function(a){console.log("There was an error loading model "+a);alert("Models: a loading error occurred. Please reload.")};null!==HL.audio&&(HL.audioLoader=new THREE.FileLoader,HL.audioLoader.setResponseType("blob"),HL.preloadDebounce=!0,HL.audioLoader.load(HL.audio,function(a){console.log("Audio Loading complete!\ndispatching HLAssetLoaded event");window.dispatchEvent(g)},function(a){a=new CustomEvent("audioProgress",{detail:a});
window.dispatchEvent(a)},function(a){console.error("Audio: An error happened "+a);alert("Audio: a loading error occurred. Please reload.")}));e();HL.lights.sun=new THREE.DirectionalLight(15663052,4);HL.lights.sun.color=HLC.horizon;HL.lights.sun.position.set(0,1999,100);HL.scene.add(HL.lights.sun);HL.lights.land=new THREE.DirectionalLight(16777215,1);HL.lights.land.position.set(0,-100,0);HL.lights.land.color=HLC.land;HL.scene.add(HL.lights.land);f();c();m();HL.sky=new THREE.Mesh(HL.geometries.sky,
HL.materials.sky);HL.sky.name="sky";HL.scene.add(HL.sky);HL.land=new THREE.Mesh(HL.geometries.land,HL.materials.land);HL.land.name="land";HL.scene.add(HL.land);HLE.MIRROR?(HL.sea=new THREE.Mesh(HL.geometries.sea,HL.materials.mirror.material),HL.sea.add(HL.materials.mirror)):HLE.WATER?(HL.sea=new THREE.Mesh(new THREE.PlaneBufferGeometry(HLE.WORLD_WIDTH,HLE.WORLD_WIDTH,16,16),HL.materials.water.material),HL.sea.add(HL.materials.water),HL.sea.rotateX(.5*-Math.PI)):HL.sea=new THREE.Mesh(HL.geometries.sea,
HL.materials.sea);HL.sea.name="sea";HL.scene.add(HL.sea);HL.clouds=new THREE.Points(HL.geometries.clouds,HL.materials.clouds);HL.clouds.name="clouds";HL.clouds.frustumCulled=!1;HL.scene.add(HL.clouds);a();n();window.addEventListener("HLAssetLoaded",b)}}}();
